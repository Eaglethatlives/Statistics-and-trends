...
def plot_relational_plot(df):
   """
   This Section Creates a 2x2 subplot with scatter plots.
   """
...
def plot_categorical_plot(df):
    """
    This Section creates a count plot, bar plot, and pie chart for categorical analysis.
   """
    ...
    sns.barplot(x='brand', y='L',hue='group', data=df, errorbar=None, palette=["pink", "yellow", "blue", "purple", "black", "brown", "red", "orange"])
...
def plot_statistical_plot(df):
    ...
    """
   This section creates a 2x2 subplot grid with histograms for statistical analysis.
   """
